...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?php echo base_url("assets/js/inserir.js"); ?>"></script>
  </head>
  <body>
    <div class="container">
      ...
      <form>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="descricao" maxlength="600">
        </div>
        ...
        <div class="form-group">
          ...
          <label class="radio-inline">
            <input type="radio" value="ativo" name="optativo">Ativo
          </label>

          <label class="radio-inline">
            <input type="radio" value="inativo" name="optativo">Inativo
          </label>
        </div>
        ...
        <button type="button" onclick="adicionar();" class="btn btn-primary">Adicionar Atividade</button>
      </form>
    </div>
